...
public  StringBuffer(java.lang.String str) { throw new RuntimeException("Stub!"); }
public  StringBuffer(java.lang.CharSequence seq) { throw new RuntimeException("Stub!"); }
...
public synchronized  java.lang.StringBuffer append(java.lang.Object obj) { throw new RuntimeException("Stub!"); }
public synchronized  java.lang.StringBuffer append(java.lang.String str) { throw new RuntimeException("Stub!"); }
public synchronized  java.lang.StringBuffer append(java.lang.StringBuffer sb) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuffer append(java.lang.CharSequence s) { throw new RuntimeException("Stub!"); }
public synchronized  java.lang.StringBuffer append(java.lang.CharSequence s, int start, int end) { throw new RuntimeException("Stub!"); }
...
public synchronized  java.lang.StringBuffer replace(int start, int end, java.lang.String str) { throw new RuntimeException("Stub!"); }
...
public synchronized  java.lang.StringBuffer insert(int offset, java.lang.Object obj) { throw new RuntimeException("Stub!"); }
public synchronized  java.lang.StringBuffer insert(int offset, java.lang.String str) { throw new RuntimeException("Stub!"); }
public synchronized  java.lang.StringBuffer insert(int offset, char[] str) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuffer insert(int dstOffset, java.lang.CharSequence s) { throw new RuntimeException("Stub!"); }
public synchronized  java.lang.StringBuffer insert(int dstOffset, java.lang.CharSequence s, int start, int end) { throw new RuntimeException("Stub!"); }
...
public synchronized  int indexOf(java.lang.String str, int fromIndex) { throw new RuntimeException("Stub!"); }
public  int lastIndexOf(java.lang.String str) { throw new RuntimeException("Stub!"); }
public synchronized  int lastIndexOf(java.lang.String str, int fromIndex) { throw new RuntimeException("Stub!"); }
