...
public  java.lang.StringBuilder append(java.lang.CharSequence s) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder append(java.lang.CharSequence s, int start, int end) { throw new RuntimeException("Stub!"); }
...
public  java.lang.StringBuilder insert(int dstOffset, java.lang.CharSequence s) { throw new RuntimeException("Stub!"); }
public  java.lang.StringBuilder insert(int dstOffset, java.lang.CharSequence s, int start, int end) { throw new RuntimeException("Stub!"); }
