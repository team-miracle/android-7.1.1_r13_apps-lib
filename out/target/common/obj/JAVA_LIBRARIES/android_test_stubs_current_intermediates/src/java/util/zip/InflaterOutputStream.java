...
public  InflaterOutputStream(java.io.OutputStream out, java.util.zip.Inflater infl) { super((java.io.OutputStream)null); throw new RuntimeException("Stub!"); }
public  InflaterOutputStream(java.io.OutputStream out, java.util.zip.Inflater infl, int bufLen) { super((java.io.OutputStream)null); throw new RuntimeException("Stub!"); }
