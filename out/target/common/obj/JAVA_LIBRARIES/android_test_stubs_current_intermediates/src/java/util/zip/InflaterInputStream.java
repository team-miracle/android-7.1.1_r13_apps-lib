...
{
public  InflaterInputStream(java.io.InputStream in, java.util.zip.Inflater inf, int size) { super((java.io.InputStream)null); throw new RuntimeException("Stub!"); }
public  InflaterInputStream(java.io.InputStream in, java.util.zip.Inflater inf) { super((java.io.InputStream)null); throw new RuntimeException("Stub!"); }
public  InflaterInputStream(java.io.InputStream in) { super((java.io.InputStream)null); throw new RuntimeException("Stub!"); }
