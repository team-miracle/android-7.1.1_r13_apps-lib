...
{
public  GnssMeasurement() { throw new RuntimeException("Stub!"); }
public  void set(android.location.GnssMeasurement measurement) { throw new RuntimeException("Stub!"); }
public  void reset() { throw new RuntimeException("Stub!"); }
public  int getSvid() { throw new RuntimeException("Stub!"); }
public  void setSvid(int value) { throw new RuntimeException("Stub!"); }
public  int getConstellationType() { throw new RuntimeException("Stub!"); }
public  void setConstellationType(int value) { throw new RuntimeException("Stub!"); }
public  double getTimeOffsetNanos() { throw new RuntimeException("Stub!"); }
public  void setTimeOffsetNanos(double value) { throw new RuntimeException("Stub!"); }
public  int getState() { throw new RuntimeException("Stub!"); }
public  void setState(int value) { throw new RuntimeException("Stub!"); }
public  long getReceivedSvTimeNanos() { throw new RuntimeException("Stub!"); }
public  void setReceivedSvTimeNanos(long value) { throw new RuntimeException("Stub!"); }
public  long getReceivedSvTimeUncertaintyNanos() { throw new RuntimeException("Stub!"); }
public  void setReceivedSvTimeUncertaintyNanos(long value) { throw new RuntimeException("Stub!"); }
public  double getCn0DbHz() { throw new RuntimeException("Stub!"); }
public  void setCn0DbHz(double value) { throw new RuntimeException("Stub!"); }
public  double getPseudorangeRateMetersPerSecond() { throw new RuntimeException("Stub!"); }
public  void setPseudorangeRateMetersPerSecond(double value) { throw new RuntimeException("Stub!"); }
public  double getPseudorangeRateUncertaintyMetersPerSecond() { throw new RuntimeException("Stub!"); }
public  void setPseudorangeRateUncertaintyMetersPerSecond(double value) { throw new RuntimeException("Stub!"); }
public  int getAccumulatedDeltaRangeState() { throw new RuntimeException("Stub!"); }
public  void setAccumulatedDeltaRangeState(int value) { throw new RuntimeException("Stub!"); }
public  double getAccumulatedDeltaRangeMeters() { throw new RuntimeException("Stub!"); }
public  void setAccumulatedDeltaRangeMeters(double value) { throw new RuntimeException("Stub!"); }
public  double getAccumulatedDeltaRangeUncertaintyMeters() { throw new RuntimeException("Stub!"); }
public  void setAccumulatedDeltaRangeUncertaintyMeters(double value) { throw new RuntimeException("Stub!"); }
...
public  void setCarrierFrequencyHz(float carrierFrequencyHz) { throw new RuntimeException("Stub!"); }
public  void resetCarrierFrequencyHz() { throw new RuntimeException("Stub!"); }
...
public  void setMultipathIndicator(int value) { throw new RuntimeException("Stub!"); }
