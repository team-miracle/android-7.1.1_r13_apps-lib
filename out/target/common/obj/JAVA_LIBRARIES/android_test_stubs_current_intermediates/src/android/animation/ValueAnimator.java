...
public static  void setDurationScale(float durationScale) { throw new RuntimeException("Stub!"); }
public static  float getDurationScale() { throw new RuntimeException("Stub!"); }
