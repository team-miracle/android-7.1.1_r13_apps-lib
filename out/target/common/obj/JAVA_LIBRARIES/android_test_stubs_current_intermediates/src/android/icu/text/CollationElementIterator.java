...
public static final  int primaryOrder(int ce) { throw new RuntimeException("Stub!"); }
public static final  int secondaryOrder(int ce) { throw new RuntimeException("Stub!"); }
public static final  int tertiaryOrder(int ce) { throw new RuntimeException("Stub!"); }
