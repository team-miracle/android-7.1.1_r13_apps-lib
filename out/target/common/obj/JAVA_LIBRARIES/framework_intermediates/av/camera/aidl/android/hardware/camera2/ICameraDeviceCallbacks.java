...
long _arg0;
_arg0 = data.readLong();
this.onRepeatingRequestError(_arg0);
return true;
}
}
...
/**
     ...
     */
@Override public void onRepeatingRequestError(long lastFrameNumber) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     * @param lastFrameNumber Frame number of the last frame of the streaming request.
     */
public void onRepeatingRequestError(long lastFrameNumber) throws android.os.RemoteException;
}
