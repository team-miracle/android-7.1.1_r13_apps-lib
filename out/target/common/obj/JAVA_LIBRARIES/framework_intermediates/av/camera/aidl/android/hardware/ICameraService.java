...
/**
     ...
     */
@Override public android.hardware.camera2.ICameraDeviceUser connectDevice(android.hardware.camera2.ICameraDeviceCallbacks callbacks, int cameraId, java.lang.String opPackageName, int clientUid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     */
@Override public void addListener(android.hardware.ICameraServiceListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     * Only supported for device HAL versions >= 3.2
     */
@Override public android.hardware.camera2.impl.CameraMetadataNative getCameraCharacteristics(int cameraId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public boolean supportsCameraApi(int cameraId, int apiVersion) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     * Only supported for device HAL versions >= 3.2
     */
public android.hardware.camera2.ICameraDeviceUser connectDevice(android.hardware.camera2.ICameraDeviceCallbacks callbacks, int cameraId, java.lang.String opPackageName, int clientUid) throws android.os.RemoteException;
/**
     * Open a camera device in legacy mode, if supported by the camera module HAL.
     */
...
/**
     * Add/remove listeners for changes to camera device and flashlight state
     */
public void addListener(android.hardware.ICameraServiceListener listener) throws android.os.RemoteException;
public void removeListener(android.hardware.ICameraServiceListener listener) throws android.os.RemoteException;
/**
     * Read the static camera metadata for a camera device.
     * Only supported for device HAL versions >= 3.2
     */
public android.hardware.camera2.impl.CameraMetadataNative getCameraCharacteristics(int cameraId) throws android.os.RemoteException;
/**
     * Read in the vendor tag descriptors from the camera module HAL.
     * Intended to be used by the native code of CameraMetadataNative to correctly
     * interpret camera metadata with vendor tags.
...
public boolean supportsCameraApi(int cameraId, int apiVersion) throws android.os.RemoteException;
