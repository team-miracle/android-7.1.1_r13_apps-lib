...
case TRANSACTION_setDeferredConfiguration:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
this.setDeferredConfiguration(_arg0, _arg1);
reply.writeNoException();
return true;
}
}
...
/**
     ...
     * <p>
     */
@Override public void endConfigure(boolean isConstrainedHighSpeed) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void setDeferredConfiguration(int streamId, android.hardware.camera2.params.OutputConfiguration outputConfiguration) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setDeferredConfiguration, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_setDeferredConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
}
...
/**
     ...
     * <p>
     */
public void endConfigure(boolean isConstrainedHighSpeed) throws android.os.RemoteException;
...
public void setDeferredConfiguration(int streamId, android.hardware.camera2.params.OutputConfiguration outputConfiguration) throws android.os.RemoteException;
}
