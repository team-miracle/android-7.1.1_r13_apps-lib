...
java.lang.String _arg1;
_arg1 = data.readString();
this.rejectWithMessage(_arg0, _arg1);
return true;
}
...
@Override public void rejectWithMessage(java.lang.String callId, java.lang.String message) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
mRemote.transact(Stub.TRANSACTION_rejectWithMessage, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
@Override public void silence(java.lang.String callId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(callId);
mRemote.transact(Stub.TRANSACTION_silence, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
@Override public void onExtrasChanged(java.lang.String callId, android.os.Bundle extras) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
static final int TRANSACTION_rejectWithMessage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_disconnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_silence = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_hold = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_unhold = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_onCallAudioStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_playDtmfTone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_stopDtmfTone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_conference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_splitFromConference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_mergeConference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_swapConference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_onPostDialContinue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_pullExternalCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_sendCallEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_onExtrasChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
}
...
public void rejectWithMessage(java.lang.String callId, java.lang.String message) throws android.os.RemoteException;
public void disconnect(java.lang.String callId) throws android.os.RemoteException;
public void silence(java.lang.String callId) throws android.os.RemoteException;
...
public void onExtrasChanged(java.lang.String callId, android.os.Bundle extras) throws android.os.RemoteException;
}
