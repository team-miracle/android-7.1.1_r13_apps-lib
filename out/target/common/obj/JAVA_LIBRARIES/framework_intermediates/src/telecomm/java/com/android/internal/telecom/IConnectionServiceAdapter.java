...
int _arg1;
_arg1 = data.readInt();
this.setConnectionProperties(_arg0, _arg1);
return true;
}
...
@Override public void setPulling(java.lang.String callId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void setConnectionProperties(java.lang.String callId, int connectionProperties) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
static final int TRANSACTION_onConnectionEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
}
...
public void setPulling(java.lang.String callId) throws android.os.RemoteException;
...
public void setConnectionProperties(java.lang.String callId, int connectionProperties) throws android.os.RemoteException;
