...
int _arg0;
_arg0 = data.readInt();
this.acceptRingingCallWithVideoState(_arg0);
reply.writeNoException();
return true;
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_dumpCallAnalytics, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
/**
     ...
     */
@Override public void acceptRingingCallWithVideoState(int videoState) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_acceptRingingCallWithVideoState, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_createManageBlockedNumbersIntent, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
static final int TRANSACTION_dumpCallAnalytics = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_silenceRinger = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_isInCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_isRinging = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getCallState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_endCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_acceptRingingCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_acceptRingingCallWithVideoState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_cancelMissedCallsNotification = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_handlePinMmi = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_handlePinMmiForPhoneAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getAdnUriForPhoneAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_isTtySupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_getCurrentTtyMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_addNewIncomingCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_addNewUnknownCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_placeCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_enablePhoneAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_setDefaultDialer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_createManageBlockedNumbersIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
}
/**
     * Brings the in-call screen to the foreground if there is an active call.
     *
...
/**
     * @see TelecomServiceImpl#acceptRingingCallWithVideoState(int)
     */
public void acceptRingingCallWithVideoState(int videoState) throws android.os.RemoteException;
/**
     * @see TelecomServiceImpl#cancelMissedCallsNotification
     */
