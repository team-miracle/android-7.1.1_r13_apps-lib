...
@Override public void onRestrictBackgroundWhitelistChanged(int uid, boolean whitelisted) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void onRestrictBackgroundBlacklistChanged(int uid, boolean blacklisted) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
static final int TRANSACTION_onRestrictBackgroundWhitelistChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_onRestrictBackgroundBlacklistChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
}
...
public void onRestrictBackgroundWhitelistChanged(int uid, boolean whitelisted) throws android.os.RemoteException;
public void onRestrictBackgroundBlacklistChanged(int uid, boolean blacklisted) throws android.os.RemoteException;
}
