...
/**
     ...
     */
@Override public void setDnsConfigurationForNetwork(int netId, java.lang.String[] servers, java.lang.String domains) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_setInterfaceIpv6NdOffload = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
...
static final int TRANSACTION_setUidMeteredNetworkBlacklist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_setUidMeteredNetworkWhitelist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_setDataSaverModeEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_setUidCleartextNetworkPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_isBandwidthControlEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_addIdleTimer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_removeIdleTimer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_setDnsConfigurationForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_setDnsServersForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_setFirewallEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_isFirewallEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_setFirewallInterfaceRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_setFirewallEgressSourceRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_setFirewallEgressDestRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_setFirewallUidRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_setFirewallUidRules = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_setFirewallChainEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_addVpnUidRanges = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_removeVpnUidRanges = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_startClatd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_stopClatd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_isClatdStarted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_registerNetworkActivityListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_unregisterNetworkActivityListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_isNetworkActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
static final int TRANSACTION_createPhysicalNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
static final int TRANSACTION_createVirtualNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
static final int TRANSACTION_removeNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 75);
static final int TRANSACTION_addInterfaceToNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 76);
static final int TRANSACTION_removeInterfaceFromNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 77);
static final int TRANSACTION_addLegacyRouteForNetId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
static final int TRANSACTION_setDefaultNetId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 79);
static final int TRANSACTION_clearDefaultNetId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
static final int TRANSACTION_setNetworkPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
static final int TRANSACTION_setPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
static final int TRANSACTION_clearPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
static final int TRANSACTION_allowProtect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
static final int TRANSACTION_denyProtect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 85);
static final int TRANSACTION_addInterfaceToLocalNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 86);
static final int TRANSACTION_removeInterfaceFromLocalNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 87);
static final int TRANSACTION_removeRoutesFromLocalNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 88);
static final int TRANSACTION_setAllowOnlyVpnForUids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 89);
}
/**
     ** GENERAL
     **//**
...
/**
     * Configure name servers, search paths, and resolver parameters for the given network.
     */
public void setDnsConfigurationForNetwork(int netId, java.lang.String[] servers, java.lang.String domains) throws android.os.RemoteException;
/**
     * Bind name servers to a network in the DNS resolver.
     */
