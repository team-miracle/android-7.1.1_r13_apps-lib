...
static final int TRANSACTION_removeUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_setUserName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setUserIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getUserIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getPrimaryUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getUsers = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getProfiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getProfileIds = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_canAddMoreManagedProfiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getProfileParent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_isSameProfileGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getUserInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getUserAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_setUserAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getUserCreationTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_isRestricted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_canHaveRestrictedProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getUserSerialNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getUserHandle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getUserRestrictionSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getUserRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_hasBaseUserRestriction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_hasUserRestriction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_setUserRestriction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_setApplicationRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getApplicationRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getApplicationRestrictionsForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_setDefaultGuestRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getDefaultGuestRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_markGuestForDeletion = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_setQuietModeEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_isQuietModeEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_trySetQuietModeDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_setSeedAccountData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_getSeedAccountName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getSeedAccountType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getSeedAccountOptions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_clearSeedAccountData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_someUserHasSeedAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_isManagedProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_isDemoUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
}
