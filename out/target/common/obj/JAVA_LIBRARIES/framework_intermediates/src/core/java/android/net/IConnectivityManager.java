...
@Override public void requestLinkProperties(android.net.NetworkRequest networkRequest) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void requestNetworkCapabilities(android.net.NetworkRequest networkRequest) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_requestLinkProperties = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_requestNetworkCapabilities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
...
static final int TRANSACTION_setAvoidUnvalidated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
...
public void requestLinkProperties(android.net.NetworkRequest networkRequest) throws android.os.RemoteException;
public void requestNetworkCapabilities(android.net.NetworkRequest networkRequest) throws android.os.RemoteException;
