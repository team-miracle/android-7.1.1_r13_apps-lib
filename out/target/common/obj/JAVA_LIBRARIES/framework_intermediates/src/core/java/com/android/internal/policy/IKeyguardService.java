...
@Override public void dismiss(boolean allowWhileOccluded) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
public void dismiss(boolean allowWhileOccluded) throws android.os.RemoteException;
