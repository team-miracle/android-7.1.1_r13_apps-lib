...
/**
     ...
     */
@Override public void repositionChild(android.view.IWindow childWindow, int left, int top, int right, int bottom, long deferTransactionUntilFrame, android.graphics.Rect outFrame) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public boolean performDrag(android.view.IWindow window, android.os.IBinder dragToken, int touchSource, float touchX, float touchY, float thumbCenterX, float thumbCenterY, android.content.ClipData data) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     */
@Override public void cancelDragAndDrop(android.os.IBinder dragToken) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_repositionChild = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_prepareToReplaceWindows = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_performDeferredDestroy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_outOfMemory = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setTransparentRegion = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_setInsets = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getDisplayFrame = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_finishDrawing = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_setInTouchMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getInTouchMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_performHapticFeedback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_prepareDrag = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_performDrag = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_reportDropResult = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_cancelDragAndDrop = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_dragRecipientEntered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_dragRecipientExited = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setWallpaperPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_wallpaperOffsetsComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_setWallpaperDisplayOffset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_sendWallpaperCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_wallpaperCommandComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_onRectangleOnScreenRequested = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getWindowId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_pokeDrawLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_startMovingTask = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_updatePointerIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
}
...
/**
     ...
     *  @param outFrame Rect in which is placed the new position/size on screen.
     */
public void repositionChild(android.view.IWindow childWindow, int left, int top, int right, int bottom, long deferTransactionUntilFrame, android.graphics.Rect outFrame) throws android.os.RemoteException;
/*
     * Notify the window manager that an application is relaunching and
     * windows should be prepared for replacement.
     *
...
/**
     * Initiate the drag operation itself
     */
public boolean performDrag(android.view.IWindow window, android.os.IBinder dragToken, int touchSource, float touchX, float touchY, float thumbCenterX, float thumbCenterY, android.content.ClipData data) throws android.os.RemoteException;
/**
     * Report the result of a drop action targeted to the given window.
     * consumed is 'true' when the drop was accepted by a valid recipient,
     * 'false' otherwise.
...
/**
     * Cancel the current drag operation.
     */
public void cancelDragAndDrop(android.os.IBinder dragToken) throws android.os.RemoteException;
/**
     * Tell the OS that we've just dragged into a View that is willing to accept the drop
     */
