...
android.media.MediaMetadata _result = this.getMetadata(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
android.media.session.PlaybackState _result = this.getPlaybackState(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
@Override public android.bluetooth.BluetoothAvrcpPlayerSettings getPlayerSettings(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public android.media.MediaMetadata getMetadata(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public android.media.session.PlaybackState getPlaybackState(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public boolean setPlayerApplicationSetting(android.bluetooth.BluetoothAvrcpPlayerSettings plAppSetting) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public void sendGroupNavigationCmd(android.bluetooth.BluetoothDevice device, int keyCode, int keyState) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getPlayerSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getMetadata = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getPlaybackState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setPlayerApplicationSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_sendGroupNavigationCmd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
}
...
public android.bluetooth.BluetoothAvrcpPlayerSettings getPlayerSettings(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException;
public android.media.MediaMetadata getMetadata(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException;
public android.media.session.PlaybackState getPlaybackState(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException;
public boolean setPlayerApplicationSetting(android.bluetooth.BluetoothAvrcpPlayerSettings plAppSetting) throws android.os.RemoteException;
public void sendGroupNavigationCmd(android.bluetooth.BluetoothDevice device, int keyCode, int keyState) throws android.os.RemoteException;
}
