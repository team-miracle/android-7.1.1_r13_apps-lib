...
@Override public void setAudioRouteAllowed(boolean allowed) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public boolean getAudioRouteAllowed() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public void bindResponse(int ind_id, boolean ind_status) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_bindResponse, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_setAudioRouteAllowed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getAudioRouteAllowed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_startScoUsingVirtualVoiceCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_stopScoUsingVirtualVoiceCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_phoneStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_clccResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_enableWBS = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_disableWBS = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_bindResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
}
// Public API
...
public void setAudioRouteAllowed(boolean allowed) throws android.os.RemoteException;
...
public void bindResponse(int ind_id, boolean ind_status) throws android.os.RemoteException;
}
