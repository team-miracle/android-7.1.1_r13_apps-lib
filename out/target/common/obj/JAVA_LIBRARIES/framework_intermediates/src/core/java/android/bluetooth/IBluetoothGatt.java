...
@Override public void startScan(int appIf, boolean isServer, android.bluetooth.le.ScanSettings settings, java.util.List<android.bluetooth.le.ScanFilter> filters, android.os.WorkSource workSource, java.util.List scanStorages, java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void writeDescriptor(int clientIf, java.lang.String address, int handle, int writeType, int authReq, byte[] value) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void startScan(int appIf, boolean isServer, android.bluetooth.le.ScanSettings settings, java.util.List<android.bluetooth.le.ScanFilter> filters, android.os.WorkSource workSource, java.util.List scanStorages, java.lang.String callingPackage) throws android.os.RemoteException;
...
public void writeDescriptor(int clientIf, java.lang.String address, int handle, int writeType, int authReq, byte[] value) throws android.os.RemoteException;
