...
static final int TRANSACTION_setDeviceLockedForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_isDeviceLocked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_isDeviceSecure = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_isTrustUsuallyManaged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
}
