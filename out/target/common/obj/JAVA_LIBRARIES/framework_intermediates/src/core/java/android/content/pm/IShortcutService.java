 ...
 * Original file: frameworks/base/core/java/android/content/pm/IShortcutService.aidl
 */
...
static final int TRANSACTION_disableShortcuts = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_enableShortcuts = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getMaxShortcutCountPerActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getRemainingCallCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getRateLimitResetTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getIconMaxDimensions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_reportShortcutUsed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_resetThrottling = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_onApplicationActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getBackupPayload = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_applyRestore = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
}
