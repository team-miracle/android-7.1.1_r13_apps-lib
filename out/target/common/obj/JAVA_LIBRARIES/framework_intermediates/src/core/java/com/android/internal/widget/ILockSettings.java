...
@Override public com.android.internal.widget.VerifyCredentialResponse checkPattern(java.lang.String pattern, int userId, com.android.internal.widget.ICheckCredentialProgressCallback progressCallback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public com.android.internal.widget.VerifyCredentialResponse checkPassword(java.lang.String password, int userId, com.android.internal.widget.ICheckCredentialProgressCallback progressCallback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.internal.widget.VerifyCredentialResponse _result;
...
@Override public com.android.internal.widget.VerifyCredentialResponse verifyTiedProfileChallenge(java.lang.String password, boolean isPattern, long challenge, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.internal.widget.VerifyCredentialResponse _result;
...
static final int TRANSACTION_checkPattern = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_verifyPattern = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
...
static final int TRANSACTION_verifyPassword = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_verifyTiedProfileChallenge = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_checkVoldPassword = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_havePattern = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_havePassword = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_setSeparateProfileChallengeEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getSeparateProfileChallengeEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_registerStrongAuthTracker = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_unregisterStrongAuthTracker = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_requireStrongAuth = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_systemReady = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_userPresent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getStrongAuthForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
}
...
public com.android.internal.widget.VerifyCredentialResponse checkPattern(java.lang.String pattern, int userId, com.android.internal.widget.ICheckCredentialProgressCallback progressCallback) throws android.os.RemoteException;
...
public com.android.internal.widget.VerifyCredentialResponse checkPassword(java.lang.String password, int userId, com.android.internal.widget.ICheckCredentialProgressCallback progressCallback) throws android.os.RemoteException;
...
public com.android.internal.widget.VerifyCredentialResponse verifyTiedProfileChallenge(java.lang.String password, boolean isPattern, long challenge, int userId) throws android.os.RemoteException;
