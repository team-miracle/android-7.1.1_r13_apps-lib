...
@Override public void setVisibilityOverride(java.lang.String pkg, int uid, int visibility) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public int getVisibilityOverride(java.lang.String pkg, int uid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public void setPriority(java.lang.String pkg, int uid, int priority) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public int getPriority(java.lang.String pkg, int uid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public void setImportance(java.lang.String pkg, int uid, int importance) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public int getImportance(java.lang.String pkg, int uid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public void applyAdjustmentFromRankerService(android.service.notification.INotificationListener token, android.service.notification.Adjustment adjustment) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void applyAdjustmentsFromRankerService(android.service.notification.INotificationListener token, java.util.List<android.service.notification.Adjustment> adjustments) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_areNotificationsEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_setVisibilityOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getVisibilityOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setPriority = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getPriority = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_setImportance = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getImportance = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getPackageImportance = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getActiveNotifications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getHistoricalNotifications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_registerListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_unregisterListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_cancelNotificationFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_cancelNotificationsFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_requestBindListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_requestUnbindListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setNotificationsShownFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getActiveNotificationsFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_requestHintsFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getHintsFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_requestInterruptionFilterFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getInterruptionFilterFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_setOnNotificationPostedTrimFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_setInterruptionFilter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_applyAdjustmentFromRankerService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_applyAdjustmentsFromRankerService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getEffectsSuppressor = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_matchesCallFilter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_isSystemConditionProviderEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_getZenMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_getZenModeConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_setZenMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_notifyConditions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_isNotificationPolicyAccessGranted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getNotificationPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_setNotificationPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_getPackagesRequestingNotificationPolicyAccess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_isNotificationPolicyAccessGrantedForPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_setNotificationPolicyAccessGranted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getAutomaticZenRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_getZenRules = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_addAutomaticZenRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_updateAutomaticZenRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_removeAutomaticZenRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_removeAutomaticZenRules = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_getRuleInstanceCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_getBackupPayload = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_applyRestore = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_getAppActiveNotifications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
}
...
public void setVisibilityOverride(java.lang.String pkg, int uid, int visibility) throws android.os.RemoteException;
public int getVisibilityOverride(java.lang.String pkg, int uid) throws android.os.RemoteException;
public void setPriority(java.lang.String pkg, int uid, int priority) throws android.os.RemoteException;
public int getPriority(java.lang.String pkg, int uid) throws android.os.RemoteException;
public void setImportance(java.lang.String pkg, int uid, int importance) throws android.os.RemoteException;
public int getImportance(java.lang.String pkg, int uid) throws android.os.RemoteException;
...
public void applyAdjustmentFromRankerService(android.service.notification.INotificationListener token, android.service.notification.Adjustment adjustment) throws android.os.RemoteException;
public void applyAdjustmentsFromRankerService(android.service.notification.INotificationListener token, java.util.List<android.service.notification.Adjustment> adjustments) throws android.os.RemoteException;
