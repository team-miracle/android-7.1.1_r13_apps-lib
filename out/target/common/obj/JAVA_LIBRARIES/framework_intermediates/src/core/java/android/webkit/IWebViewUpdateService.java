...
static final int TRANSACTION_isFallbackPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_enableFallbackLogic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
}
/**
     * Used by the relro file creator to notify the service that it's done.
     */
