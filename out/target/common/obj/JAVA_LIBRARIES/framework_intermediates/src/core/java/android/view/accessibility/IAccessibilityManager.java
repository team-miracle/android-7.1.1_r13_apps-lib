...
@Override public void enableAccessibilityService(android.content.ComponentName service, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void disableAccessibilityService(android.content.ComponentName service, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_enableAccessibilityService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_disableAccessibilityService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
}
...
public void enableAccessibilityService(android.content.ComponentName service, int userId) throws android.os.RemoteException;
public void disableAccessibilityService(android.content.ComponentName service, int userId) throws android.os.RemoteException;
}
