...
static final int TRANSACTION_reportFullscreenMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_sendKeyEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_clearMetaKeyStates = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_performPrivateCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_setComposingRegion = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getSelectedText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_requestUpdateCursorAnchorInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_commitContent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
}
