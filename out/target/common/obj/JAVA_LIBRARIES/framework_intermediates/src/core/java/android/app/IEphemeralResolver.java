 ...
 * Original file: frameworks/base/core/java/android/app/IEphemeralResolver.aidl
 */
package android.app;
/** @hide */
...
@Override public void getEphemeralResolveInfoList(android.os.IRemoteCallback callback, int[] digestPrefix, int prefixMask, int sequence) throws android.os.RemoteException
{
...
public void getEphemeralResolveInfoList(android.os.IRemoteCallback callback, int[] digestPrefix, int prefixMask, int sequence) throws android.os.RemoteException;
}
