...
static final int TRANSACTION_updateBleAppCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_isBleAppPresent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
}
