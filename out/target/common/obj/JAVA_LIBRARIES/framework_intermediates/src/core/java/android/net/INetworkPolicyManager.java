...
@Override public void setConnectivityListener(android.net.INetworkPolicyListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void addRestrictBackgroundWhitelistedUid(int uid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removeRestrictBackgroundWhitelistedUid(int uid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public int[] getRestrictBackgroundWhitelistedUids() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
...
static final int TRANSACTION_setConnectivityListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
...
static final int TRANSACTION_onTetheringChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_addRestrictBackgroundWhitelistedUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_removeRestrictBackgroundWhitelistedUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getRestrictBackgroundWhitelistedUids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getRestrictBackgroundByCaller = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setDeviceIdleMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getNetworkQuotaInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_isNetworkMetered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
}
/** Control UID policies. */
...
/** Higher priority listener before general event dispatch */
public void setConnectivityListener(android.net.INetworkPolicyListener listener) throws android.os.RemoteException;
...
/** Control which applications can be exempt from background data restrictions */
public void addRestrictBackgroundWhitelistedUid(int uid) throws android.os.RemoteException;
public void removeRestrictBackgroundWhitelistedUid(int uid) throws android.os.RemoteException;
