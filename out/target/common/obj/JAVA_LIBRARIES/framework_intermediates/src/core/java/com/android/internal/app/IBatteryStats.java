...
@Override public void setBatteryState(int status, int health, int plugType, int level, int temp, int volt, int chargeUAh) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void noteBleScanStarted(android.os.WorkSource ws) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void noteBleScanStopped(android.os.WorkSource ws) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_noteLongPartialWakelockFinish = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_noteVibratorOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_noteVibratorOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_noteStartGps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_noteStopGps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_noteScreenState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_noteScreenBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_noteUserActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_noteWakeUp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_noteInteractive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_noteConnectivityChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_noteMobileRadioPowerState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_notePhoneOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_notePhoneOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_notePhoneSignalStrength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_notePhoneDataConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_notePhoneState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_noteWifiOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_noteWifiOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_noteWifiRunning = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_noteWifiRunningChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_noteWifiStopped = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_noteWifiState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_noteWifiSupplicantStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_noteWifiRssiChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_noteFullWifiLockAcquired = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_noteFullWifiLockReleased = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_noteWifiScanStarted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_noteWifiScanStopped = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_noteWifiMulticastEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_noteWifiMulticastDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_noteFullWifiLockAcquiredFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_noteFullWifiLockReleasedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_noteWifiScanStartedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_noteWifiScanStoppedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_noteWifiBatchedScanStartedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_noteWifiBatchedScanStoppedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_noteWifiMulticastEnabledFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_noteWifiMulticastDisabledFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
...
static final int TRANSACTION_takeUidSnapshot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 79);
static final int TRANSACTION_takeUidSnapshots = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
static final int TRANSACTION_noteBluetoothControllerActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
static final int TRANSACTION_noteModemControllerActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
static final int TRANSACTION_noteWifiControllerActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
}
// These first methods are also called by native code, so must
// be kept in sync with frameworks/native/include/binder/IBatteryStats.h
...
public void setBatteryState(int status, int health, int plugType, int level, int temp, int volt, int chargeUAh) throws android.os.RemoteException;
...
public void noteBleScanStarted(android.os.WorkSource ws) throws android.os.RemoteException;
public void noteBleScanStopped(android.os.WorkSource ws) throws android.os.RemoteException;
