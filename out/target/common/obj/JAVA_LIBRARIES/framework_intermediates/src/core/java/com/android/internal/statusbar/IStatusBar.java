...
/**
     ...
     */
@Override public void showTvPictureInPictureMenu() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
static final int TRANSACTION_toggleSplitScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
...
static final int TRANSACTION_dismissKeyboardShortcutsMenu = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_toggleKeyboardShortcutsMenu = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_appTransitionPending = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_appTransitionCancelled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_appTransitionStarting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_appTransitionFinished = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_showAssistDisclosure = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_startAssist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_onCameraLaunchGestureDetected = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_showTvPictureInPictureMenu = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
...
static final int TRANSACTION_handleSystemNavigationKey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
}
...
/**
     * Shows the TV's picture-in-picture menu if an activity is in picture-in-picture mode.
     */
public void showTvPictureInPictureMenu() throws android.os.RemoteException;
