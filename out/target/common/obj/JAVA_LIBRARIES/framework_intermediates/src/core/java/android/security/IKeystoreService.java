...
@Override public int getKeyCharacteristics(java.lang.String alias, android.security.keymaster.KeymasterBlob clientId, android.security.keymaster.KeymasterBlob appId, int uid, android.security.keymaster.KeyCharacteristics characteristics) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public android.security.keymaster.ExportResult exportKey(java.lang.String alias, int format, android.security.keymaster.KeymasterBlob clientId, android.security.keymaster.KeymasterBlob appId, int uid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public android.security.keymaster.OperationResult begin(android.os.IBinder appToken, java.lang.String alias, int purpose, boolean pruneable, android.security.keymaster.KeymasterArguments params, byte[] entropy, int uid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public int attestKey(java.lang.String alias, android.security.keymaster.KeymasterArguments params, android.security.keymaster.KeymasterCertificateChain chain) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_attestKey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
}
...
public int getKeyCharacteristics(java.lang.String alias, android.security.keymaster.KeymasterBlob clientId, android.security.keymaster.KeymasterBlob appId, int uid, android.security.keymaster.KeyCharacteristics characteristics) throws android.os.RemoteException;
...
public android.security.keymaster.ExportResult exportKey(java.lang.String alias, int format, android.security.keymaster.KeymasterBlob clientId, android.security.keymaster.KeymasterBlob appId, int uid) throws android.os.RemoteException;
public android.security.keymaster.OperationResult begin(android.os.IBinder appToken, java.lang.String alias, int purpose, boolean pruneable, android.security.keymaster.KeymasterArguments params, byte[] entropy, int uid) throws android.os.RemoteException;
...
public int attestKey(java.lang.String alias, android.security.keymaster.KeymasterArguments params, android.security.keymaster.KeymasterCertificateChain chain) throws android.os.RemoteException;
}
