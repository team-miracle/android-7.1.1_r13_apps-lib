...
@Override public void startInput(com.android.internal.view.IInputContext inputContext, int missingMethods, android.view.inputmethod.EditorInfo attribute) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void restartInput(com.android.internal.view.IInputContext inputContext, int missingMethods, android.view.inputmethod.EditorInfo attribute) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
public void startInput(com.android.internal.view.IInputContext inputContext, int missingMethods, android.view.inputmethod.EditorInfo attribute) throws android.os.RemoteException;
public void restartInput(com.android.internal.view.IInputContext inputContext, int missingMethods, android.view.inputmethod.EditorInfo attribute) throws android.os.RemoteException;
