...
static final int TRANSACTION_addTile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_remTile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_clickTile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_handleSystemNavigationKey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
}
