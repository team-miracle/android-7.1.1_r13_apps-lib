...
@Override public android.hardware.input.KeyboardLayout getKeyboardLayoutForInputDevice(android.hardware.input.InputDeviceIdentifier identifier, android.view.inputmethod.InputMethodInfo imeInfo, android.view.inputmethod.InputMethodSubtype imeSubtype) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.hardware.input.KeyboardLayout _result;
...
@Override public void setKeyboardLayoutForInputDevice(android.hardware.input.InputDeviceIdentifier identifier, android.view.inputmethod.InputMethodInfo imeInfo, android.view.inputmethod.InputMethodSubtype imeSubtype, java.lang.String keyboardLayoutDescriptor) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getKeyboardLayoutsForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getKeyboardLayout = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getCurrentKeyboardLayoutForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_setCurrentKeyboardLayoutForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getEnabledKeyboardLayoutsForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_addKeyboardLayoutForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_removeKeyboardLayoutForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getKeyboardLayoutForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_setKeyboardLayoutForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_registerInputDevicesChangedListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_isInTabletMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_registerTabletModeChangedListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_vibrate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_cancelVibrate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setPointerIconType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setCustomPointerIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
}
// Gets input device information.
...
public android.hardware.input.KeyboardLayout getKeyboardLayoutForInputDevice(android.hardware.input.InputDeviceIdentifier identifier, android.view.inputmethod.InputMethodInfo imeInfo, android.view.inputmethod.InputMethodSubtype imeSubtype) throws android.os.RemoteException;
public void setKeyboardLayoutForInputDevice(android.hardware.input.InputDeviceIdentifier identifier, android.view.inputmethod.InputMethodInfo imeInfo, android.view.inputmethod.InputMethodSubtype imeSubtype, java.lang.String keyboardLayoutDescriptor) throws android.os.RemoteException;
// Registers an input devices changed listener.
