...
@Override public void addSharedAccountsFromParentUser(int parentUserId, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_addSharedAccountsFromParentUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
...
static final int TRANSACTION_startAddAccountSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_startUpdateCredentialsSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_finishSessionAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_someUserHasAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_isCredentialsUpdateSuggested = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_hasAccountAccess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_createRequestAccountAccessIntentSenderAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_onAccountAccessed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
}
...
public void addSharedAccountsFromParentUser(int parentUserId, int userId) throws android.os.RemoteException;
/* Account renaming. */
