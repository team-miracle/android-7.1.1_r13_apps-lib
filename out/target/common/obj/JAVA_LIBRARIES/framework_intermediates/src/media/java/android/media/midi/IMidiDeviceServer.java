...
@Override public int connectPorts(android.os.IBinder token, android.os.ParcelFileDescriptor pfd, int outputPortNumber) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
public int connectPorts(android.os.IBinder token, android.os.ParcelFileDescriptor pfd, int outputPortNumber) throws android.os.RemoteException;
