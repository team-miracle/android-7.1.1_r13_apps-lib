...
case TRANSACTION_setVisualVoicemailEnabled:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
this.setVisualVoicemailEnabled(_arg0, _arg1, _arg2);
return true;
}
case TRANSACTION_isVisualVoicemailEnabled:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
boolean _result = this.isVisualVoicemailEnabled(_arg0, _arg1);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
case TRANSACTION_getSystemVisualVoicemailSmsFilterSettings:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
int _arg1;
_arg1 = data.readInt();
android.telephony.VisualVoicemailSmsFilterSettings _result = this.getSystemVisualVoicemailSmsFilterSettings(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
java.lang.String _arg1;
_arg1 = data.readString();
android.telephony.IccOpenLogicalChannelResponse _result = this.iccOpenLogicalChannel(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
long _result = this.getVtDataUsage();
reply.writeNoException();
...
@Override public int getCallStateForSlot(int slotId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int getActivePhoneTypeForSlot(int slotId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public void setVisualVoicemailEnabled(java.lang.String callingPackage, android.telecom.PhoneAccountHandle accountHandle, boolean enabled) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
mRemote.transact(Stub.TRANSACTION_setVisualVoicemailEnabled, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
@Override public boolean isVisualVoicemailEnabled(java.lang.String callingPackage, android.telecom.PhoneAccountHandle accountHandle) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_isVisualVoicemailEnabled, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
@Override public android.telephony.VisualVoicemailSmsFilterSettings getSystemVisualVoicemailSmsFilterSettings(java.lang.String packageName, int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.telephony.VisualVoicemailSmsFilterSettings _result;
...
_data.writeInt(subId);
mRemote.transact(Stub.TRANSACTION_getSystemVisualVoicemailSmsFilterSettings, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.telephony.VisualVoicemailSmsFilterSettings.CREATOR.createFromParcel(_reply);
}
...
/**
     ...
     */
@Override public android.telephony.IccOpenLogicalChannelResponse iccOpenLogicalChannel(int subId, java.lang.String AID) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     *   {@link android.Manifest.permission#READ_PHONE_STATE READ_PHONE_STATE}
     */
@Override public java.lang.String getImeiForSlot(int slotId, java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     *   {@link android.Manifest.permission#READ_PHONE_STATE READ_PHONE_STATE}
     */
@Override public java.lang.String getDeviceSoftwareVersionForSlot(int slotId, java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
@Override public int setAllowedCarriers(int slotId, java.util.List<android.service.carrier.CarrierIdentifier> carriers) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
/**
     ...
     */
@Override public java.util.List<android.service.carrier.CarrierIdentifier> getAllowedCarriers(int slotId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     * @hide
     */
@Override public long getVtDataUsage() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
static final int TRANSACTION_getCallStateForSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
...
static final int TRANSACTION_getActivePhoneTypeForSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
...
static final int TRANSACTION_setVoiceMailNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_getVoiceMessageCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_getVoiceMessageCountForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_setVisualVoicemailEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_isVisualVoicemailEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_enableVisualVoicemailSmsFilter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_disableVisualVoicemailSmsFilter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_getVisualVoicemailSmsFilterSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_getSystemVisualVoicemailSmsFilterSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_getNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_getNetworkTypeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_getDataNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_getDataNetworkTypeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_getVoiceNetworkTypeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_hasIccCard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_hasIccCardUsingSlotId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_getLteOnCdmaMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_getLteOnCdmaModeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_getAllCellInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
static final int TRANSACTION_setCellInfoListRate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
static final int TRANSACTION_getDefaultSim = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
static final int TRANSACTION_iccOpenLogicalChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 75);
static final int TRANSACTION_iccCloseLogicalChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 76);
static final int TRANSACTION_iccTransmitApduLogicalChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 77);
static final int TRANSACTION_iccTransmitApduBasicChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
static final int TRANSACTION_iccExchangeSimIO = (android.os.IBinder.FIRST_CALL_TRANSACTION + 79);
static final int TRANSACTION_sendEnvelopeWithStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
static final int TRANSACTION_nvReadItem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
static final int TRANSACTION_nvWriteItem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
static final int TRANSACTION_nvWriteCdmaPrl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
static final int TRANSACTION_nvResetConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
static final int TRANSACTION_getCalculatedPreferredNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 85);
static final int TRANSACTION_getPreferredNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 86);
static final int TRANSACTION_getTetherApnRequired = (android.os.IBinder.FIRST_CALL_TRANSACTION + 87);
static final int TRANSACTION_setNetworkSelectionModeAutomatic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 88);
static final int TRANSACTION_getCellNetworkScanResults = (android.os.IBinder.FIRST_CALL_TRANSACTION + 89);
static final int TRANSACTION_setNetworkSelectionModeManual = (android.os.IBinder.FIRST_CALL_TRANSACTION + 90);
static final int TRANSACTION_setPreferredNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 91);
static final int TRANSACTION_setDataEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 92);
static final int TRANSACTION_getDataEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 93);
static final int TRANSACTION_getPcscfAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 94);
static final int TRANSACTION_setImsRegistrationState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 95);
static final int TRANSACTION_getCdmaMdn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 96);
static final int TRANSACTION_getCdmaMin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 97);
static final int TRANSACTION_getCarrierPrivilegeStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 98);
static final int TRANSACTION_checkCarrierPrivilegesForPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 99);
static final int TRANSACTION_checkCarrierPrivilegesForPackageAnyPhone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 100);
static final int TRANSACTION_getCarrierPackageNamesForIntentAndPhone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 101);
static final int TRANSACTION_setLine1NumberForDisplayForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 102);
static final int TRANSACTION_getLine1NumberForDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 103);
static final int TRANSACTION_getLine1AlphaTagForDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 104);
static final int TRANSACTION_getMergedSubscriberIds = (android.os.IBinder.FIRST_CALL_TRANSACTION + 105);
static final int TRANSACTION_setOperatorBrandOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 106);
static final int TRANSACTION_setRoamingOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 107);
static final int TRANSACTION_invokeOemRilRequestRaw = (android.os.IBinder.FIRST_CALL_TRANSACTION + 108);
static final int TRANSACTION_needMobileRadioShutdown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 109);
static final int TRANSACTION_shutdownMobileRadios = (android.os.IBinder.FIRST_CALL_TRANSACTION + 110);
static final int TRANSACTION_setRadioCapability = (android.os.IBinder.FIRST_CALL_TRANSACTION + 111);
static final int TRANSACTION_getRadioAccessFamily = (android.os.IBinder.FIRST_CALL_TRANSACTION + 112);
static final int TRANSACTION_enableVideoCalling = (android.os.IBinder.FIRST_CALL_TRANSACTION + 113);
static final int TRANSACTION_isVideoCallingEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 114);
static final int TRANSACTION_canChangeDtmfToneLength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 115);
static final int TRANSACTION_isWorldPhone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 116);
static final int TRANSACTION_isTtyModeSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 117);
static final int TRANSACTION_isHearingAidCompatibilitySupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 118);
static final int TRANSACTION_isImsRegistered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 119);
static final int TRANSACTION_isWifiCallingAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 120);
static final int TRANSACTION_isVolteAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 121);
static final int TRANSACTION_isVideoTelephonyAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 122);
static final int TRANSACTION_getDeviceId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 123);
static final int TRANSACTION_getImeiForSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 124);
static final int TRANSACTION_getDeviceSoftwareVersionForSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 125);
static final int TRANSACTION_getSubIdForPhoneAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 126);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 127);
static final int TRANSACTION_getLocaleFromDefaultSim = (android.os.IBinder.FIRST_CALL_TRANSACTION + 128);
static final int TRANSACTION_requestModemActivityInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 129);
static final int TRANSACTION_getServiceStateForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 130);
static final int TRANSACTION_getVoicemailRingtoneUri = (android.os.IBinder.FIRST_CALL_TRANSACTION + 131);
static final int TRANSACTION_isVoicemailVibrationEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 132);
static final int TRANSACTION_getPackagesWithCarrierPrivileges = (android.os.IBinder.FIRST_CALL_TRANSACTION + 133);
static final int TRANSACTION_getAidForAppType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 134);
static final int TRANSACTION_getEsn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 135);
static final int TRANSACTION_getCdmaPrlVersion = (android.os.IBinder.FIRST_CALL_TRANSACTION + 136);
static final int TRANSACTION_getTelephonyHistograms = (android.os.IBinder.FIRST_CALL_TRANSACTION + 137);
static final int TRANSACTION_setAllowedCarriers = (android.os.IBinder.FIRST_CALL_TRANSACTION + 138);
static final int TRANSACTION_getAllowedCarriers = (android.os.IBinder.FIRST_CALL_TRANSACTION + 139);
static final int TRANSACTION_carrierActionSetMeteredApnsEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 140);
static final int TRANSACTION_carrierActionSetRadioEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 141);
static final int TRANSACTION_getVtDataUsage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 142);
static final int TRANSACTION_setPolicyDataEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 143);
}
/**
     * Dial a number. This doesn't place the call. It displays
     * the Dialer screen.
...
public int getCallStateForSlot(int slotId) throws android.os.RemoteException;
...
public int getActivePhoneTypeForSlot(int slotId) throws android.os.RemoteException;
...
public void setVisualVoicemailEnabled(java.lang.String callingPackage, android.telecom.PhoneAccountHandle accountHandle, boolean enabled) throws android.os.RemoteException;
public boolean isVisualVoicemailEnabled(java.lang.String callingPackage, android.telecom.PhoneAccountHandle accountHandle) throws android.os.RemoteException;
// Not oneway, caller needs to make sure the vaule is set before receiving a SMS
...
public android.telephony.VisualVoicemailSmsFilterSettings getSystemVisualVoicemailSmsFilterSettings(java.lang.String packageName, int subId) throws android.os.RemoteException;
...
/**
     ...
     * @return an IccOpenLogicalChannelResponse object.
     */
public android.telephony.IccOpenLogicalChannelResponse iccOpenLogicalChannel(int subId, java.lang.String AID) throws android.os.RemoteException;
/**
     * Closes a previously opened logical channel to the ICC card.
     *
     * Input parameters equivalent to TS 27.007 AT+CCHC command.
...
/**
     ...
     *   {@link android.Manifest.permission#READ_PHONE_STATE READ_PHONE_STATE}
     */
public java.lang.String getImeiForSlot(int slotId, java.lang.String callingPackage) throws android.os.RemoteException;
/**
     * Returns the device software version.
     *
     * @param slotId - device slot.
     ...
     *   {@link android.Manifest.permission#READ_PHONE_STATE READ_PHONE_STATE}
     */
public java.lang.String getDeviceSoftwareVersionForSlot(int slotId, java.lang.String callingPackage) throws android.os.RemoteException;
...
public int setAllowedCarriers(int slotId, java.util.List<android.service.carrier.CarrierIdentifier> carriers) throws android.os.RemoteException;
/**
     * Get the allowed carrier list for slotId.
     * Require system privileges. In the future we may add this to carrier APIs.
     *
     ...
     * means all carriers are allowed.
     */
public java.util.List<android.service.carrier.CarrierIdentifier> getAllowedCarriers(int slotId) throws android.os.RemoteException;
/**
     * Action set from carrier signalling broadcast receivers to enable/disable metered apns
     * Permissions android.Manifest.permission.MODIFY_PHONE_STATE is required
     * @param subId the subscription ID that this action applies to.
