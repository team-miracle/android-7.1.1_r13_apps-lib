...
mRemote.transact(Stub.TRANSACTION_registrationConnectedWithRadioTech, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(imsRadioTech);
mRemote.transact(Stub.TRANSACTION_registrationProgressingWithRadioTech, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_registrationAssociatedUriChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
