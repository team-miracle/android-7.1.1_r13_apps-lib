...
case TRANSACTION_addPasspointManagementObject:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
int _result = this.addPasspointManagementObject(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_modifyPasspointManagementObject:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
java.util.List<android.net.wifi.PasspointManagementObjectDefinition> _arg1;
_arg1 = data.createTypedArrayList(android.net.wifi.PasspointManagementObjectDefinition.CREATOR);
int _result = this.modifyPasspointManagementObject(_arg0, _arg1);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
case TRANSACTION_setEnableAutoJoinWhenAssociated:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
boolean _result = this.setEnableAutoJoinWhenAssociated(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public int addPasspointManagementObject(java.lang.String mo) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_addPasspointManagementObject, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public int modifyPasspointManagementObject(java.lang.String fqdn, java.util.List<android.net.wifi.PasspointManagementObjectDefinition> mos) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_modifyPasspointManagementObject, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public boolean setEnableAutoJoinWhenAssociated(boolean enabled) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_setEnableAutoJoinWhenAssociated, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_addOrUpdateNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_addPasspointManagementObject = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_modifyPasspointManagementObject = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_queryPasspointIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_matchProviderWithCurrentNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_deauthenticateNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_removeNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_enableNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_disableNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_pingSupplicant = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_startScan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getScanResults = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_disconnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_reconnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_reassociate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getConnectionInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setWifiEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getWifiEnabledState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_setCountryCode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getCountryCode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setFrequencyBand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getFrequencyBand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_isDualBandSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_saveConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
...
static final int TRANSACTION_setWifiApEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getWifiApEnabledState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getWifiApConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_buildWifiConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_setWifiApConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_addToBlacklist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_clearBlacklist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getWifiServiceMessenger = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_getConfigFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_enableTdls = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_enableTdlsWithMacAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
...
static final int TRANSACTION_getAggressiveHandover = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_setAllowScansWithTraffic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_getAllowScansWithTraffic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_setEnableAutoJoinWhenAssociated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_getEnableAutoJoinWhenAssociated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_enableWifiConnectivityManager = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_getConnectionStatistics = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_disableEphemeralNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_getCurrentNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
}
...
public int addPasspointManagementObject(java.lang.String mo) throws android.os.RemoteException;
public int modifyPasspointManagementObject(java.lang.String fqdn, java.util.List<android.net.wifi.PasspointManagementObjectDefinition> mos) throws android.os.RemoteException;
...
public boolean setEnableAutoJoinWhenAssociated(boolean enabled) throws android.os.RemoteException;
