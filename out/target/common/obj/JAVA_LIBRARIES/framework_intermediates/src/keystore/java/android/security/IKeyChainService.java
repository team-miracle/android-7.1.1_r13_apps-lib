...
case TRANSACTION_getCaCertificates:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
@Override public byte[] getCaCertificates(java.lang.String alias) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
byte[] _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(alias);
mRemote.transact(Stub.TRANSACTION_getCaCertificates, _data, _reply, 0);
_reply.readException();
_result = _reply.createByteArray();
}
finally {
...
@Override public boolean installKeyPair(byte[] privateKey, byte[] userCert, byte[] certChain, java.lang.String alias) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public boolean removeKeyPair(java.lang.String alias) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
static final int TRANSACTION_getCaCertificates = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_installCaCertificate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_installKeyPair = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_removeKeyPair = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_deleteCaCertificate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_reset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getUserCaAliases = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getSystemCaAliases = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_containsCaAlias = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getEncodedCaCertificate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getCaCertificateChainAliases = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_setGrant = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_hasGrant = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
}
// APIs used by KeyChain
...
public byte[] getCaCertificates(java.lang.String alias) throws android.os.RemoteException;
// APIs used by CertInstaller

public void installCaCertificate(byte[] caCertificate) throws android.os.RemoteException;
// APIs used by DevicePolicyManager

public boolean installKeyPair(byte[] privateKey, byte[] userCert, byte[] certChain, java.lang.String alias) throws android.os.RemoteException;
public boolean removeKeyPair(java.lang.String alias) throws android.os.RemoteException;
// APIs used by Settings
