...
static final int TRANSACTION_suspend = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
...
static final int TRANSACTION_resetStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
