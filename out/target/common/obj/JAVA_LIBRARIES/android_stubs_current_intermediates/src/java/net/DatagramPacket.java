...
public  DatagramPacket(byte[] buf, int offset, int length, java.net.SocketAddress address) throws java.net.SocketException { throw new RuntimeException("Stub!"); }
public  DatagramPacket(byte[] buf, int length, java.net.InetAddress address, int port) { throw new RuntimeException("Stub!"); }
public  DatagramPacket(byte[] buf, int length, java.net.SocketAddress address) throws java.net.SocketException { throw new RuntimeException("Stub!"); }
