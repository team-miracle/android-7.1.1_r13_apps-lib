 ...
 * Original file: packages/services/Car/car-lib/src/android/car/hardware/ICarSensor.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_getSupportedSensors, _data, _reply, 0);
...
/**
     ...
     */
@Override public boolean registerOrUpdateSensorListener(int sensorType, int rate, android.car.hardware.ICarSensorEventListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_registerOrUpdateSensorListener, _data, _reply, 0);
_reply.readException();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(sensorType);
mRemote.transact(Stub.TRANSACTION_getLatestSensorEvent, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
/**
     ...
     * be affected.
     */
@Override public void unregisterSensorListener(int sensorType, android.car.hardware.ICarSensorEventListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(sensorType);
_data.writeStrongBinder((((listener!=null))?(listener.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_unregisterSensorListener, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     * @return false if requested sensors cannot be subscribed / started.
     */
public boolean registerOrUpdateSensorListener(int sensorType, int rate, android.car.hardware.ICarSensorEventListener listener) throws android.os.RemoteException;
/**
     * get latest sensor event for the type. If there was no update after car connection, it will
     * return null immediately.
     */
...
/**
     ...
     * be affected.
     */
public void unregisterSensorListener(int sensorType, android.car.hardware.ICarSensorEventListener listener) throws android.os.RemoteException;
}
