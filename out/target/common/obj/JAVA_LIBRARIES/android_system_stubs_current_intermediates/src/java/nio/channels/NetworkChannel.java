...
{
public abstract  java.nio.channels.NetworkChannel bind(java.net.SocketAddress local) throws java.io.IOException;
public abstract  java.net.SocketAddress getLocalAddress() throws java.io.IOException;
public abstract <T> java.nio.channels.NetworkChannel setOption(java.net.SocketOption<T> name, T value) throws java.io.IOException;
