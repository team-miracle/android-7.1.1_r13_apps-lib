...
public static final  int primaryOrder(int order) { throw new RuntimeException("Stub!"); }
public static final  short secondaryOrder(int order) { throw new RuntimeException("Stub!"); }
public static final  short tertiaryOrder(int order) { throw new RuntimeException("Stub!"); }
