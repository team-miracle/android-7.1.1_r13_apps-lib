...
public static <E> java.util.Set<E> singleton(E o) { throw new RuntimeException("Stub!"); }
public static <E> java.util.List<E> singletonList(E o) { throw new RuntimeException("Stub!"); }
