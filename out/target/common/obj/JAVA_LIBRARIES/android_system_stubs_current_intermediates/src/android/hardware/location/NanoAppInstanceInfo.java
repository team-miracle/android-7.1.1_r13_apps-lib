...
{
public  NanoAppInstanceInfo() { throw new RuntimeException("Stub!"); }
...
public  int getContexthubId() { throw new RuntimeException("Stub!"); }
public  int getHandle() { throw new RuntimeException("Stub!"); }
public  int describeContents() { throw new RuntimeException("Stub!"); }
public  void writeToParcel(android.os.Parcel out, int flags) { throw new RuntimeException("Stub!"); }
public  java.lang.String toString() { throw new RuntimeException("Stub!"); }
public static final android.os.Parcelable.Creator<android.hardware.location.NanoAppInstanceInfo> CREATOR;
static { CREATOR = null; }
}
