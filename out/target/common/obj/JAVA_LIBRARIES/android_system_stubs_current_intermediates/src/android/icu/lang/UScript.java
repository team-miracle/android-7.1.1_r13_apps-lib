...
UScript() { throw new RuntimeException("Stub!"); }
public static final  int[] getCode(java.util.Locale locale) { throw new RuntimeException("Stub!"); }
public static final  int[] getCode(android.icu.util.ULocale locale) { throw new RuntimeException("Stub!"); }
public static final  int[] getCode(java.lang.String nameOrAbbrOrLocale) { throw new RuntimeException("Stub!"); }
public static final  int getCodeFromName(java.lang.String nameOrAbbr) { throw new RuntimeException("Stub!"); }
public static final  int getScript(int codepoint) { throw new RuntimeException("Stub!"); }
public static final  boolean hasScript(int c, int sc) { throw new RuntimeException("Stub!"); }
public static final  int getScriptExtensions(int c, java.util.BitSet set) { throw new RuntimeException("Stub!"); }
public static final  java.lang.String getName(int scriptCode) { throw new RuntimeException("Stub!"); }
public static final  java.lang.String getShortName(int scriptCode) { throw new RuntimeException("Stub!"); }
public static final  java.lang.String getSampleString(int script) { throw new RuntimeException("Stub!"); }
public static final  android.icu.lang.UScript.ScriptUsage getUsage(int script) { throw new RuntimeException("Stub!"); }
public static final  boolean isRightToLeft(int script) { throw new RuntimeException("Stub!"); }
public static final  boolean breaksBetweenLetters(int script) { throw new RuntimeException("Stub!"); }
public static final  boolean isCased(int script) { throw new RuntimeException("Stub!"); }
