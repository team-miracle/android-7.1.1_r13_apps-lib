...
public  OutputConfiguration(android.view.Surface surface, int rotation) { throw new RuntimeException("Stub!"); }
public  OutputConfiguration(int surfaceGroupId, android.view.Surface surface, int rotation) { throw new RuntimeException("Stub!"); }
