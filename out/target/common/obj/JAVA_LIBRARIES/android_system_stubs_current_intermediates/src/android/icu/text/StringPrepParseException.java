...
{
public  StringPrepParseException(java.lang.String message, int error) { super((java.lang.String)null,0); throw new RuntimeException("Stub!"); }
public  StringPrepParseException(java.lang.String message, int error, java.lang.String rules, int pos) { super((java.lang.String)null,0); throw new RuntimeException("Stub!"); }
public  StringPrepParseException(java.lang.String message, int error, java.lang.String rules, int pos, int lineNumber) { super((java.lang.String)null,0); throw new RuntimeException("Stub!"); }
