...
public static final class MetadataSync
  implements android.provider.BaseColumns, android.provider.ContactsContract.MetadataSyncColumns
{
MetadataSync() { throw new RuntimeException("Stub!"); }
...
public static final android.net.Uri METADATA_AUTHORITY_URI;
static { CONTENT_URI = null; METADATA_AUTHORITY_URI = null; }
}
...
public static final class MetadataSyncState
  implements android.provider.BaseColumns, android.provider.ContactsContract.MetadataSyncStateColumns
{
MetadataSyncState() { throw new RuntimeException("Stub!"); }
