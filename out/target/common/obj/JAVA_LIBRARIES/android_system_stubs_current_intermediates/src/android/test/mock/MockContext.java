...
public  android.content.Context createCredentialProtectedStorageContext() { throw new RuntimeException("Stub!"); }
public  boolean isDeviceProtectedStorage() { throw new RuntimeException("Stub!"); }
public  boolean isCredentialProtectedStorage() { throw new RuntimeException("Stub!"); }
}
