...
public static  android.os.UserHandle of(int userId) { throw new RuntimeException("Stub!"); }
public static  int myUserId() { throw new RuntimeException("Stub!"); }
@Deprecated
public  boolean isOwner() { throw new RuntimeException("Stub!"); }
public  boolean isSystem() { throw new RuntimeException("Stub!"); }
